...
public class BookAppoinmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBook = findViewById(R.id.buttonBMBAppointment);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmentExists(username,title+" => "+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    Toast.makeText(BookAppoinmentActivity.this, "Appointment already boooked", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    Toast.makeText(BookAppoinmentActivity.this, "Appointment Done Sucessfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(BookAppoinmentActivity.this,HomeActivity2.class));
                }
            }
        });
    }
